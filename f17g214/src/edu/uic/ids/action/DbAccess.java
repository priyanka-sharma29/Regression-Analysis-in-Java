...
public class DbAccess {
	...
	public ResultSet selectQueryProcessing(String query)
	{
		try {
			...
			try {
				...
				message = "Sorry, application encountered an SQL Exception at this moment, find the error details below and forward it to the support team(support.f17g214@uic.edu) for further assistance" +  "\n" + "SQL Error Code: " + se.getErrorCode() + "\n"+  "SQL State: " + se.getSQLState() + "\n" +
						"Message :" + se.getMessage() + "\n";
				se.printStackTrace();
				return resultSet;
			}
	...
	public ResultSet[] fetchTables()
	{
		...
		{
			se.printStackTrace();
			message = "SQL Exception has occured while fetching the tables, find the error details below and forward it to the support team(support.f17g214@uic.edu) for further assistance" + "\n" + "SQL State: " + se.getSQLState() + "\n" +  "SQL Error Code: " + se.getErrorCode() + "\n" +
					"Message :" + se.getMessage() + "\n";
	...
	public ResultSet fetchTableData(String sqlQuery)
	{
		try {
			...
			message = "SQL Exception has occured while fetching data from the tables, find the error details below and forward it to the support team(support.f17g214@uic.edu) for further assistance"+ "\n" + "Error Code: " + se.getErrorCode() + "\n" +
					"SQL State: " + se.getSQLState() + "\n" +
					"Message :" + se.getMessage();
			return resultSet = null;
		} catch (Exception e) {e.printStackTrace();
